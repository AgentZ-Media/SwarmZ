  ...
  return <>
    <Popover open={remindersOpen} onOpenChange={setRemindersOpen}>
      ...
      <PopoverContent align="end" className="max-h-[calc(100dvh-5rem)] w-[min(380px,calc(100vw-2rem))] overflow-y-auto p-3">
        ...
        <button type="button" onClick={() => void add()} disabled={note.trim().length < 2 || !at} className="focus-ring mt-2 h-8 w-full rounded-md bg-acc text-11 font-semibold text-white disabled:opacity-40">Schedule reminder</button>
